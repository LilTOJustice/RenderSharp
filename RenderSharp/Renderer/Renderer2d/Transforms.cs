...
namespace RenderSharp.Render2d
{
    ...
    {
        public static FVec2 ScreenToWorld2(in Vec2 screenSize, double aspectRatio, in Vec2 screenCoords, in FVec2 cameraCenter, double cameraZoom, double cameraRotation)
        {
        ...
        public static Vec2 WorldToBgTexture2(in FVec2 worldCoord, in Vec2 bgTextureSize, in FVec2 worldRelativeSize)
        {
        ...
        public static bool WorldToActor2(in FVec2 worldCoord, in FVec2 actorPosition, in FVec2 actorSize, double actorRotation, out FVec2 actorLoc)
        {
        ...
        public static bool ActorToTexture2(in FVec2 actorCoords, in FVec2 actorSize, in Vec2 textureSize, out Vec2 textureInd)
        {
